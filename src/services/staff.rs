...
struct CreateEmployeePayload {
    ...
    email: String,
    address: String,
    employer_dealership_rif: MaybeNull<String>,
...
struct UpdateEmployeePartiallyPayload {
    ...
    employer_dealership_rif: MaybeAbsent<MaybeNull<String>>,
...
async fn update_employee_completely(
    ...
    let updated_employee = UpdateEmployee {
        ...
        employer_dealership_rif: Some(payload.employer_dealership_rif.into()),
